...
def build_helical(rad,p):
    ...
    for row,inward,xy,phase0,bank_group,ul_group in rows:
        x,y=xy
        # For side banks the radial dimension is x and the tangential width is y.
        # Top/bottom banks use the opposite orientation.  This keeps all four
        # rectangular banks physically consistent around the beam aperture.
